...
Known Issues:
  ...
  - AI output consistency: Lesson/quiz quality varies with qwen3:0.6b; needs prompt refinement or model evaluation
...
Pending Decisions:
  - Model selection: Evaluate gemma3:4b vs granite4.1:3b vs qwen3:0.6b for lesson quality/speed tradeoff on 6GB VRAM
